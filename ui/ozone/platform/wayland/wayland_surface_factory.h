...
class WaylandSurfaceFactory : public SurfaceFactoryOzone {
 public:
  ...
  void RegisterSurface(gfx::AcceleratedWidget widget, GbmSurfacelessWayland* surface);
 ...
 private:
  ...
  std::map<gfx::AcceleratedWidget, GbmSurfacelessWayland*> widget_to_surface_map_;
