...
WaylandConnectionConnector::WaylandConnectionConnector(WaylandConnection* connection) : connection_(connection) {}
...
void WaylandConnectionConnector::OnMessageReceived(const IPC::Message& message) {}
