...
gfx::NativePixmapHandle GbmPixmapLinux::ExportHandle() {
  ...
  gfx::BufferFormat format =
      ui::GetBufferFormatFromFourCCFormat(buffer_->get_format());
...
gfx::BufferFormat GbmPixmapLinux::GetBufferFormat() const {
  return ui::GetBufferFormatFromFourCCFormat(buffer_->get_format());
}
