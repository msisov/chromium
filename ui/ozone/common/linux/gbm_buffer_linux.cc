...
uint32_t GbmBufferLinux::GetFramebufferId() const {
  NOTREACHED();
  return 0;
}

uint32_t GbmBufferLinux::GetOpaqueFramebufferId() const {
  NOTREACHED();
  return 0;
}
...
uint32_t GbmBufferLinux::GetFramebufferPixelFormat() const {
  NOTREACHED();
  return 0;
}

uint32_t GbmBufferLinux::GetOpaqueFramebufferPixelFormat() const {
  NOTREACHED();
  return 0;
}
...
const DrmDevice* GbmBufferLinux::GetDrmDevice() const {
  NOTREACHED();
  return nullptr;
}
